<template>
  <div class="heade"><svg version="1.0" class="logo" xmlns="http://www.w3.org/2000/svg"
                          width="3295.000000pt" height="965.000000pt" viewBox="0 0 3295.000000 965.000000"
...
1283 l0 1172 -625 0 -626 0 4 -1347z"/>
    ...
    <div class="sign_in">Личный кабинет</div>
    <div class="tarifs">Тарифы</div>
    <div class="contacts">Контакты</div>
  </div>

  <div class="mail">
    <h1>Напишите нам</h1>
    <p>ADonut@thebest.ru</p>
  </div>

  <div class="socials">
    <h1>Вступайте в группу</h1>
    <p>@ADonut_the_best</p>
  </div>
...
@font-face {
  ...
  src: local('Styrene A Web Bold'), local('Styrene-A-Web-Bold'),
